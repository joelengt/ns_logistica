...
$btn_add_element_work_order.addEventListener('click', function (element){
	...
	$.ajax({
		method: 'post',
		url: `http://localhost:5000/dashboard/ordenes_trabajo/${work_order_id}/add-item/${type_service}`,
...
$ArticlesContainer.on('click', 'a.btn_edit_element', function (ev) {
  ...
  $.ajax({
  	method: 'post',
  	url: `http://localhost:5000/dashboard/ordenes_trabajo/${work_order_id}/edit/${type_service}/${service_id}`,
  	success: function (result) {
