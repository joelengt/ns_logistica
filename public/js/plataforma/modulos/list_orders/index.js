    ...
    success: function (result) {
      ...
      for(var i = 0; i <= work_orders.length - 1; i++) {
          ...
          var template = `<article class="Article__read__item  box_item" data-id="${item._id}">
                            ...
                            <form action="/plataforma/work-order/${item._id}/change-status/en_proceso" method="post">
                              <button class="btn_article_detalles btn btn-lg btn-info"> Generar ruta </button>
                            </form>
                          </article>`
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            var template = `<article class="Article__read__item  box_item" data-id="${item._id}">
                              ...
                              <div>
                                <form action="/plataforma/work-order/edit/${item._id}", method="post">
                                  <button class="btn_article_edit btn btn-lg btn-primary"> Editar </button>
                                </form>
                                <form action="/plataforma/work-order/${item._id}/change-status/reportado", method="post">
                                  <textarea name="comment_message">
                                  </textarea>
                                  <button class="class="btn_article_edit btn btn-lg btn-danger">
                                    Reportar
                                  </button>
                                </form>
                              </div>
              ...
              if(result_type_service.status === 'ok') {
                ...
                if(result_type_service.type === 'poste') {
                  ...
                  template_serviec_info = `<article class="Article__read__item  box_item" data-id="${item._id}">
                                            ...
                                            <form action="/plataforma/work-order/edit/poste/${item._id}", method="post">
                                              <button class="btn_article_edit btn btn-lg btn-primary"> Editar </button>
                                            </form>
                                          </article>`
                  ...
                  template_serviec_info  = `<article class="Article__read__item  box_item" data-id="${item._id}">
                                            ...
                                            <p> coordenada_X: ${item.coordenada_X} </p>
                                            <p> coordenada_Y: ${item.coordenada_Y} </p>
                                            <form action="/plataforma/work-order/edit/cliente/${item._id}", method="post">
                                              <button class="btn_article_edit btn btn-lg btn-primary"> Editar </button>
                                            </form>
                                          </article>`
